...
function filterTable(elem) { // eslint-disable-line no-unused-vars
    ...
    <h1>test_login.py</h1>
    <p>Report generated on 08-Mar-2023 at 10:49:30 by <a href="https://pypi.python.org/pypi/pytest-html">pytest-html</a> v3.2.0</p>
    <h2>Environment</h2>
    <table id="environment">
      ...
      <tr>
        <td>Plugins</td>
        <td>{"allure-pytest": "2.13.0", "html": "3.2.0", "metadata": "2.0.4", "xdist": "3.2.0"}</td></tr>
      <tr>
        <td>Python</td>
        <td>3.10.7</td></tr></table>
    <h2>Summary</h2>
    <p>2 tests ran in 30.47 seconds. </p>
    ...
    <table id="results-table">
      ...
      <tbody class="passed results-table-row">
        <tr>
          ...
          <td class="col-duration">23.92</td>
      ...
      <tbody class="passed results-table-row">
        <tr>
          ...
          <td class="col-duration">11.89</td>
          <td class="col-links"></td></tr>
        <tr>
          <td class="extra" colspan="4">
